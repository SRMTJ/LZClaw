...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    shortcutDescNewChat: '开始一个新的 LZClaw 任务',
    shortcutDescFocusPrompt: '跳回 LZClaw 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 LZClaw 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 LZClaw Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'LZClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 LZClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 LZClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'LZClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 LZClaw 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 LZClaw 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 LZClaw 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 LZClaw 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'LZClaw 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'LZClaw 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    browserWebAccessDescription: '使用 LZClaw 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'LZClaw 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 LZClaw 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'LZClaw 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 LZClaw 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 LZClaw 可以打开此域名',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'LZClaw服务协议',
    privacyDialogDesc: '在使用LZClaw之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'LZClaw服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用LZClaw',
  ...
  en: {
    ...
    copied: 'Copied',
    copyrightHolder: 'LZClaw. All rights reserved.',
    ...
    shortcutScopeHint: 'Shortcuts only run while the LZClaw window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutOpenCowork: 'Open LZClaw',
    ...
    shortcutDescNewChat: 'Start a new LZClaw task',
    shortcutDescFocusPrompt: 'Return to LZClaw and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the LZClaw task view',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit LZClaw Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    // LZClaw
    cowork: 'LZClaw',
    coworkSettings: 'LZClaw Settings',
    ...
    coworkWorkingDirectoryHint: 'LZClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for LZClaw...',
    coworkSystemPromptHint: "Optional system prompt to customize LZClaw's behavior",
    ...
    coworkModelSettingsHint:
      'LZClaw uses the current model and provider configuration from Model Settings.',
    ...
    modelSelectorNoModels: 'Please log in first',
    ...
    openClawDataBackupBlockingTitle: 'Backing up LZClaw data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import LZClaw data',
    ...
    openClawDataMigrationConfirmTitle: 'Import LZClaw data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save LZClaw settings. Please try again.',
    ...
    coworkPermissionDescription: 'LZClaw is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'LZClaw needs your input',
    ...
    browserWebAccessDescription: 'Use the LZClaw separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'LZClaw starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for LZClaw, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'LZClaw will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means LZClaw will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means LZClaw can open this domain',
    ...
    // Privacy dialog
    privacyDialogTitle: 'LZClaw Terms of Service',
    privacyDialogDesc:
      'Before using LZClaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'LZClaw Terms of Service',
