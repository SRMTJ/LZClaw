...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aiSkinCreationGuide: '可前往“专家套件”使用「海豚买买AI工作台外观定制」，或直接开始创作。',
    ...
    aiSkinDeleteManagedCopyNote: '只会删除海豚买买AI工作台管理的皮肤副本，不会删除会话中的原始生成图片或卸载 AI 皮肤设计师套件。',
    aiSkinDeleteFailed: '删除皮肤失败，请重试',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整海豚买买AI工作台界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    shortcutOpenCowork: '打开海豚买买AI工作台',
    ...
    shortcutDescNewChat: '开始一个新的海豚买买AI工作台任务',
    shortcutDescFocusPrompt: '跳回海豚买买AI工作台并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到海豚买买AI工作台任务视图',
    ...
    dailyCheckInLoginHint: '登录只在海豚买买AI工作台客户端中完成，活动不会获取账号令牌',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录海豚买买AI工作台Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: '海豚买买AI工作台将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为海豚买买AI工作台设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义海豚买买AI工作台的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: '海豚买买AI工作台使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份海豚买买AI工作台数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入海豚买买AI工作台数据',
    ...
    openClawDataMigrationConfirmTitle: '导入海豚买买AI工作台数据备份？',
    ...
    coworkConfigSaveFailed: '保存海豚买买AI工作台配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: '海豚买买AI工作台请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: '海豚买买AI工作台需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkHomeTagline: '我是海豚买买AI工作台，你的全场景办公 Agent',
    ...
    updateDownloadTimeout: '更新包下载长时间未收到数据，请检查网络后重试',
    ...
    updateNoRelease: '暂无已发布更新',
    updatePlatformUnavailable: '当前平台暂无可用更新',
    ...
    coworkGoalInputPlaceholder: '海豚买买AI工作台应继续朝哪个目标努力？',
    ...
    coworkShareImageTagline: '7×24 小时帮你干活的全场景个人助理，由海豚买买开发',
    ...
    coworkErrorModelSourceLobsterAIPlan: '海豚买买AI工作台套餐',
    ...
    businessCenterLoadFailed: '业务中心加载失败',
    businessCenterRetry: '重新加载',
    // 站点
    sitesTitle: '站点',
    ...
    browserWebAccessDescription: '使用海豚买买AI工作台独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: '海豚买买AI工作台启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription:
      '默认开启。关闭后仅作为海豚买买AI工作台配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: '海豚买买AI工作台不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着海豚买买AI工作台不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着海豚买买AI工作台可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许海豚买买AI工作台发送通知。',
    ...
    usageAnalyticsEnabled: '帮助改进海豚买买AI工作台',
  ...
  en: {
    ...
    aiSkinCreationGuide: 'Use “Customize 海豚买买AI工作台” in Expert Kits, or start here.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only 海豚买买AI工作台-managed skin copies are removed. Original images in the conversation and the AI Skin Designer kit are kept.',
    aiSkinDeleteFailed: 'Failed to delete the skin. Please try again.',
    uiFontSize: 'UI font size',
    uiFontSizeDescription: 'Adjust the base size used for the 海豚买买AI工作台 UI',
    ...
    shortcutScopeHint:
      'Shortcuts only run while the 海豚买买AI工作台 window is focused; while a text field is focused, only shortcuts with a Cmd/Ctrl modifier trigger.',
    ...
    shortcutOpenCowork: 'Open 海豚买买AI工作台',
    ...
    shortcutDescNewChat: 'Start a new 海豚买买AI工作台 task',
    shortcutDescFocusPrompt: 'Return to 海豚买买AI工作台 and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the 海豚买买AI工作台 task view',
    ...
    dailyCheckInLoginHint: 'Login is handled by 海豚买买AI工作台; the activity never receives account tokens',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit 海豚买买AI工作台 Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    siteQuotaChooseHint: 'Choose an online site. 海豚买买AI工作台 will never stop one automatically.',
    ...
    artifactPreviewCardLobsterBrowser: '海豚买买AI工作台 Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in 海豚买买AI工作台 Browser',
    ...
    // 海豚买买AI工作台
    cowork: '海豚买买AI工作台',
    coworkSettings: '海豚买买AI工作台 Settings',
    ...
    coworkWorkingDirectoryHint: '海豚买买AI工作台 will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for 海豚买买AI工作台...',
    coworkSystemPromptHint: "Optional system prompt to customize 海豚买买AI工作台's behavior",
    ...
    coworkModelSettingsHint:
      '海豚买买AI工作台 uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up 海豚买买AI工作台 data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import 海豚买买AI工作台 data',
    openClawDataMigrationBlockingDesc:
    ...
    openClawDataMigrationConfirmTitle: 'Import 海豚买买AI工作台 data backup?',
    openClawDataMigrationConfirmDesc:
    ...
    coworkConfigSaveFailed: 'Failed to save 海豚买买AI工作台 settings. Please try again.',
    ...
    coworkPermissionDescription: '海豚买买AI工作台 is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: '海豚买买AI工作台 needs your input',
    ...
    coworkHomeTagline: "I'm 海豚买买AI工作台, your all-in-one office agent",
    ...
    updateDownloadTimeout: 'The update download stopped receiving data. Check your connection and try again.',
    ...
    updateNoRelease: 'No published update',
    updatePlatformUnavailable: 'No update available for this platform',
    ...
    coworkGoalInputPlaceholder: 'What goal should 海豚买买AI工作台 keep working toward?',
    ...
    coworkShareImageTagline: 'A 24/7 all-scenario personal assistant developed by 海豚买买',
    ...
    coworkErrorModelGroupMissing:
      'Plan model access is misconfigured. Ask an administrator to assign the API key to a model group.',
    coworkErrorQuotaExhausted:
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add 海豚买买AI工作台 to your antivirus allowlist.',
    ...
    coworkErrorModelSourceLobsterAIPlan: '海豚买买AI工作台 plan',
    ...
    businessCenterLoadFailed: 'Failed to load Business Center',
    businessCenterRetry: 'Reload',
    // Sites
    sitesTitle: 'Sites',
    ...
    browserWebAccessDescription: 'Use the 海豚买买AI工作台 separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription:
      '海豚买买AI工作台 starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription:
      'Enabled by default. Turning it off is stored for 海豚买买AI工作台, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: '海豚买买AI工作台 will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means 海豚买买AI工作台 will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means 海豚买买AI工作台 can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow 海豚买买AI工作台 to send notifications in the system settings.',
    ...
    usageAnalyticsEnabled: 'Help improve 海豚买买AI工作台',
    usageAnalyticsEnabledDescription:
    ...
    welcomeLoginCompleting: 'Completing sign-in...',
    welcomeLoginTimeout: 'Login timed out. Please check your network and try again.',
    welcomeLoginRetry: 'Retry',
    welcomeCancel: 'Cancel',
    ...
    welcomeLoginFailed: 'Sign-in failed. Please try again.',
