...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    minimaxOAuthHint:
      "通过 MiniMax Portal 完成 OAuth 授权，无需手动填写 API 密钥",
    import: "导入",
    export: "导出",
    ...
    coworkOpenClawInstallHint:
      "OpenClaw 运行时已内置。切换到该引擎或启动任务时会自动拉起网关。",
    ...
    coworkOpenClawReadyNotice:
      "OpenClaw runtime 已就绪。开始任务时会自动启动网关。",
    ...
    coworkMemoryLegacyNotice:
      "当前为 OpenClaw 引擎模式。本页功能仅对 Cowork 生效。",
    ...
    coworkDestructiveOperation:
      "高危操作：此命令可能导致不可逆的数据丢失，请务必确认。",
    coworkCautionOperation:
      "注意：此命令可能会修改文件或系统状态，请仔细检查。",
    ...
    mcpDesc_google_drive:
      "Google Drive 文件访问和搜索，自动导出 Workspace 文件",
    mcpDesc_gmail: "Gmail 邮件管理：读取、发送、搜索邮件，支持自动认证",
    mcpDesc_google_calendar:
      "Google Calendar 日程管理：创建、查询、更新日历事件",
    ...
    emailAllowInsecureCertHint:
      "跳过 TLS 证书验证，适用于代理/VPN 导致的自签名证书问题",
    emailMailbox: "默认收件箱",
    ...
    imAgentBindingHint:
      "选择用于响应该平台消息的 Agent，不同 Agent 有不同的人设和技能配置。",
    ...
    imDingtalkGuideStep1:
      '前往钉钉开放平台，在"应用开发 > 机器人"中创建或选择一个企业内部应用',
    imDingtalkGuideStep2:
      "从应用凭证页获取 Client ID（AppKey）与 Client Secret（AppSecret）",
    imDingtalkGuideStep3:
      '启用"机器人"能力，并将 Client ID 和 Client Secret 填入下方',
    imDingtalkGuideStep4: "保存后机器人将自动通过 Stream 模式建立长连接",
    imFeishuGuideStep1:
      "在下方填写飞书机器人的 App ID 和 App Secret 即可完成配置",
    ...
    imDiscordGuideStep3:
      "在 Bot – Privileged Gateway Intents 中开启消息内容和服务器成员意图",
    imDiscordGuideStep4:
      '在 OAuth2 URL 生成器中勾选"bot"与"applications.commands"并添加消息权限',
    ...
    privacyDialogDesc:
      "在使用网易有道LobsterAI之前，请您仔细阅读{link}内容，并进行确认。",
  ...
  en: {
    ...
    aboutExportLogsPartial:
      "Logs exported (missing logs were filled as empty files)",
    testMode: "Test Mode",
    theme: "Theme",
    ...
    minimaxOAuthStatusPending:
      "Waiting for authorization, please complete login in browser...",
    ...
    minimaxOAuthHint:
      "Authorize via MiniMax Portal OAuth, no need to enter API key manually",
    import: "Import",
    export: "Export",
    ...
    coworkMemoryLegacyNotice:
      "OpenClaw engine mode is active. This page only applies to Cowork.",
    ...
    coworkConfigSaveFailed:
      "Failed to save LobsterAI settings. Please try again.",
    ...
    coworkErrorInsufficientBalance:
      "Insufficient API balance. Please top up and try again.",
    coworkErrorInputTooLong:
    ...
    coworkErrorServiceRestart:
      "AI engine is restarting. Please try again later.",
    coworkErrorGatewayDraining:
      "AI engine is restarting. Please wait a moment and try again.",
    ...
    coworkErrorEngineNotReady:
      "AI engine is starting up. Please wait a few seconds and try again.",
    coworkErrorUnknown:
    ...
    addSkill: "Add",
    addSkillSecurityTip:
      "Verify the safety of third-party skills before adding",
    ...
    securityIssuesFound:
      "Please be aware of the following behaviors in {name}:",
    ...
    securityFindingJsxray_serialize_environment:
      "Serializes environment variables (process.env)",
    ...
    mcpDesc_tavily:
      "Real-time web search, intelligent data extraction and web crawling",
    mcpDesc_github:
      "GitHub platform integration: repos, issues, PRs, Actions management",
    mcpDesc_gitlab:
      "GitLab API integration: project management, merge requests, pipelines",
    mcpDesc_context7:
      "Up-to-date library documentation and code examples for AI coding",
    mcpDesc_google_drive:
      "Google Drive file access and search with auto-export for Workspace files",
    mcpDesc_gmail:
      "Gmail management: read, send, search emails with auto authentication",
    mcpDesc_google_calendar:
      "Google Calendar management: create, query, update calendar events",
    mcpDesc_notion: "Notion API: search, create/update pages, manage databases",
    mcpDesc_slack:
      "Slack workspace: channel management, messaging, user queries",
    mcpDesc_todoist:
      "Task management: create, update, complete and organize to-do items",
    mcpDesc_playwright:
      "Advanced browser automation supporting Chromium/Firefox/WebKit",
    mcpDesc_canva:
      "Canva design platform: create and manage designs, template operations",
    mcpDesc_firecrawl:
      "Web scraping and data extraction: batch processing, structured extraction and content analysis",
    mcpDesc_fetch:
      "Web content fetching and HTML-to-markdown conversion for LLM consumption",
    ...
    nimGuideStep3:
      'Create an IM account (accid) in "Account Numbers - Sub-feature Configuration"',
    nimGuideStep4:
      "Generate a Token (password) for this account - long-term validity recommended",
    ...
    nimTeamPolicyAllowlist:
      "Allowlist - Only respond to @mentions in specified teams",
    ...
    nimQChatEnabledHint:
      "Subscribe to QChat messages, only responds to @mentions",
    nimQChatServerIds: "QChat Server IDs",
    nimQChatServerIdsPlaceholder:
      "Leave empty to auto-discover all joined servers",
    nimQChatServerIdsHint:
    ...
    imWecomQuickSetupSuccess:
      "Bot created successfully, credentials auto-filled",
    ...
    imDingtalkGuideStep4:
      "Once saved, the bot will auto-connect via Stream mode",
    imFeishuGuideStep1:
      "Enter the Feishu bot App ID and App Secret below to complete setup",
    imFeishuGuideStep2:
    ...
    feishuBotCreateWizardSuccessDesc:
      "Your Feishu bot has been configured and is ready to use.",
    ...
    imWecomGuideStep1:
      "Create a new bot application in the WeCom Admin Console",
    ...
    imWeixinGuideStep3:
      "Once connected, you can chat with AI via WeChat messages",
    ...
    imPopoCredentialHint:
      "Get AppKey, AppSecret and AES Key from the POPO Developer Portal",
    imPopoGuideStep1:
      "Create a new bot application in the POPO Developer Portal",
    ...
    imQQGuideStep1:
      "Sign up on QQ Open Platform (q.qq.com) and create a bot application",
    imQQGuideStep2:
      'Find the AppID (numeric) and Client Secret under "Development Settings"',
    ...
    scheduledTasksFormAgentId: "Agent ID",
    scheduledTasksFormAgentIdPlaceholder:
      "Optional, leave blank to use the default agent",
    ...
    scheduledTasksFormTimeoutSecondsPlaceholder:
      "Optional, blank or 0 uses the default",
    ...
    scheduledTasksFormValidationTimeout:
    ...
    scheduledTasksSessionNotSynced:
      "Failed to sync session. Please try again later.",
    ...
    scheduledTasksAdvancedSchedule:
      "Advanced schedule (edit via conversation only)",
    ...
    scheduledTasksFormNotifyConversationPlaceholder:
