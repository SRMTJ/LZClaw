...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    onboardingHintBody: '模型、插件、IM、浏览器访问和运行方式都可以在设置中继续调整。',
    onboardingStepWelcomeTitle: '欢迎来到 LZClaw',
    onboardingStepWelcomeSubtitle: '一个面向本地项目、文件和自动化任务的 AI 桌面协作入口。',
    onboardingStepWelcomeDetail1: '从左侧任务区创建会话，让主 Agent 读取项目、规划步骤并执行命令。',
    onboardingStepWelcomeDetail2: '运行过程会展示工具调用、权限请求、上下文和生成结果，方便你随时接管。',
    onboardingStepWelcomeDetail3: '首次配置只需要几步，完成后会直接进入主工作台。',
    ...
    onboardingStepWorkspaceTitle: '面向真实项目工作',
    onboardingStepWorkspaceSubtitle: '选择目录后，Agent 会在你的本地工作区里读取文件、运行命令并保留上下文。',
    onboardingStepWorkspaceDetail1: '支持代码、文档、图片、浏览器预览、任务计划和 OpenClaw 插件能力。',
    onboardingStepWorkspaceDetail2: '危险操作会走权限确认，方便你在自动化和可控性之间保持平衡。',
    onboardingStepWorkspaceDetail3: '多 Agent、Skills、MCP 和 IM Bot 可以按需逐步开启，不需要一次配置完。',
    ...
    onboardingStepStartTitle: '开始使用 LZClaw',
    onboardingStepStartSubtitle: '完成快速引导后，LZClaw 会带你进入安全的工作入口。',
    onboardingStepStartDetail1: '保留本地项目、OpenClaw 插件、Skills 和自动化任务能力。',
    onboardingStepStartDetail2: '进入工作台前会确认账号状态，未登录时先完成登录。',
    onboardingStepStartDetail3: '后续可以在设置中继续调整模型、插件、诊断和外观。',
    onboardingStartCardTitle: '准备开始',
    onboardingStartCardSubtitle: '点击开始使用，完成引导并进入下一步。',
    onboardingStepLoginTitle: '登录 LZClaw',
    onboardingStepLoginSubtitle: '登录后可以同步账号能力、使用在线服务入口，并保留本地项目协作体验。',
    onboardingStepLoginDetail1: '同步账号权益、在线服务入口和订阅状态。',
    onboardingStepLoginDetail2: '继续使用本地项目、OpenClaw 插件、Skills 和自动化任务。',
    onboardingStepLoginDetail3: '如果暂时不登录，也可以先进入应用并配置自己的模型。',
    onboardingLoginCardTitle: '登录账号',
    onboardingLoginCardSubtitle: '将在浏览器中打开登录页，完成后自动回到 LZClaw。',
    onboardingLoginPrimary: '登录 LZClaw 账号',
    onboardingLoginCustomModel: '先配置自定义模型',
    onboardingLoginSkip: '暂不登录，进入应用',
  ...
  en: {
    ...
    onboardingEyebrow: 'LZClaw quick start',
    onboardingBack: 'Back',
    onboardingNext: 'Next',
    ...
    onboardingHintBody: 'Models, plugins, IM, browser access, and runtime behavior can all be adjusted in Settings.',
    onboardingStepWelcomeTitle: 'Welcome to LZClaw',
    onboardingStepWelcomeSubtitle: 'A desktop AI workspace for local projects, files, and automated tasks.',
    onboardingStepWelcomeDetail1: 'Create a task from the left rail so the main agent can inspect projects, plan work, and run commands.',
    onboardingStepWelcomeDetail2: 'Tool calls, permission requests, context, and generated results stay visible so you can step in at any time.',
    onboardingStepWelcomeDetail3: 'First-time setup only takes a few steps, then LZClaw opens the main workspace.',
    ...
    onboardingStepWorkspaceSubtitle: 'After you choose a folder, the agent can read files, run commands, and keep local context.',
    onboardingStepWorkspaceDetail1: 'Code, documents, images, browser previews, scheduled tasks, and OpenClaw plugins are supported.',
    onboardingStepWorkspaceDetail2: 'Sensitive actions go through permission prompts so automation stays under your control.',
    onboardingStepWorkspaceDetail3: 'Multi-agent workflows, Skills, MCP, and IM bots can be enabled gradually when you need them.',
    ...
    onboardingStepStartTitle: 'Start using LZClaw',
    onboardingStepStartSubtitle: 'After the quick guide, LZClaw takes you to the secure workspace entry.',
    onboardingStepStartDetail1: 'Keep local projects, OpenClaw plugins, Skills, and automation tasks available.',
    onboardingStepStartDetail2: 'LZClaw checks account status before entering the workspace and asks you to sign in when needed.',
    onboardingStepStartDetail3: 'You can adjust models, plugins, diagnostics, and appearance later in Settings.',
    onboardingStartCardTitle: 'Ready to start',
    onboardingStartCardSubtitle: 'Select Start using to finish onboarding and continue.',
    onboardingStepLoginTitle: 'Sign in to LZClaw',
    onboardingStepLoginSubtitle:
      'Sign in to connect account capabilities and online services while keeping your local project workflow.',
    onboardingStepLoginDetail1: 'Sync account benefits, online service access, and subscription status.',
    onboardingStepLoginDetail2: 'Keep using local projects, OpenClaw plugins, Skills, and automation tasks.',
    onboardingStepLoginDetail3: 'You can also enter the app now and configure your own model later.',
    onboardingLoginCardTitle: 'Sign in',
    onboardingLoginCardSubtitle: 'The login page opens in your browser and returns to LZClaw automatically.',
    onboardingLoginPrimary: 'Sign in to LZClaw',
    onboardingLoginCustomModel: 'Configure custom model first',
    onboardingLoginSkip: 'Skip sign-in and enter app',
