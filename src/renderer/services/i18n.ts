...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    myAccount: '我的',
    personalCenter: '个人中心',
    personalCenterSubtitle: '查看当前账号、套餐和积分额度。',
    personalCenterAccountInfo: '账号信息',
    personalCenterQuotaOverview: '额度概览',
    personalCenterWorkspace: '企业工作区',
    personalCenterCurrentWorkspace: '当前工作区',
    personalCenterWorkspaceRole: '工作区角色',
    personalCenterSwitchWorkspace: '切换工作区',
    personalCenterSwitchingWorkspace: '正在切换工作区',
    personalCenterSwitchWorkspaceFailed: '切换工作区失败',
    personalCenterUserId: '用户 ID',
    personalCenterAccountStatus: '账号状态',
    personalCenterPlan: '当前套餐',
    personalCenterSubscriptionStatus: '订阅状态',
    personalCenterCreditsLimit: '总额度',
    personalCenterCreditsUsed: '已使用',
    personalCenterCreditsRemaining: '剩余额度',
    personalCenterCreditBreakdown: '积分明细',
    personalCenterNoCreditItems: '暂无积分明细',
    personalCenterNoExpiry: '长期有效',
    personalCenterRefresh: '刷新信息',
    personalCenterRefreshing: '刷新中',
    personalCenterRefreshFailed: '刷新个人信息失败',
    personalCenterLogoutFailed: '退出登录失败',
    personalCenterLoggingOut: '退出中',
    login: '登录',
    inDevelopment: '正在开发中',
    ...
    appStartingTitle: 'LZClaw 启动中',
    appStartingSubtitle: '正在初始化...',
    appStartingSlowHint: '首次启动正在加载配置和本地服务，请稍候',
    ...
    mcpServers: 'MCP',
    businessCenter: '业务中心',
    businessCenterComingSoon: '该模块即将开放',
    businessCenterOrgTitle: '组织架构管理',
    businessCenterOrgDescription: '管理企业组织架构，支持新增、编辑、启停和删除组织节点，数据实时生效。',
    businessCenterOrgSearchPlaceholder: '搜索组织节点名称/编码',
    businessCenterOrgAllStatus: '全部状态',
    businessCenterOrgActive: '启用',
    businessCenterOrgDisabled: '停用',
    businessCenterOrgAdd: '新增组织节点',
    businessCenterOrgCode: '组织节点编码',
    businessCenterOrgStructure: '组织架构',
    businessCenterOrgManager: '负责人',
    businessCenterOrgStatus: '状态',
    businessCenterOrgCreatedAt: '创建时间',
    businessCenterOrgActions: '操作',
    businessCenterOrgEdit: '编辑',
    businessCenterOrgEnable: '启用',
    businessCenterOrgDisable: '停用',
    businessCenterOrgDelete: '删除',
    businessCenterOrgMore: '更多操作',
    businessCenterOrgEmpty: '暂无匹配组织节点',
    businessCenterOrgLoading: '正在加载组织架构',
    businessCenterOrgCreateTitle: '新增组织节点',
    businessCenterOrgEditTitle: '编辑组织节点',
    businessCenterOrgName: '组织节点名称',
    businessCenterOrgParent: '上级组织',
    businessCenterOrgNoParent: '无上级组织',
    businessCenterOrgSort: '排序',
    businessCenterOrgNamePlaceholder: '请输入组织节点名称',
    businessCenterOrgCodePlaceholder: '请输入组织节点编码',
    businessCenterOrgManagerPlaceholder: '请选择负责人',
    businessCenterOrgSortPlaceholder: '请输入排序，数字越小越靠前',
    businessCenterOrgClose: '关闭弹窗',
    businessCenterOrgCancel: '取消',
    businessCenterOrgSave: '保存',
    businessCenterOrgSaving: '保存中',
    businessCenterOrgNameRequired: '请输入组织节点名称',
    ...
    businessCenterEmployeeTitle: '员工管理',
    businessCenterEmployeeDescription: '管理员工账号、所属组织、状态和应用权限。',
    businessCenterEmployeeTotal: '员工总数',
    businessCenterEmployeeActive: '已启用',
    businessCenterEmployeeDisabled: '已停用',
    businessCenterEmployeeAddedThisMonth: '本月新增',
    businessCenterEmployeeAllMembers: '当前企业全部成员',
    businessCenterEmployeeCurrentMonth: '本月创建成员',
    businessCenterEmployeeNameSearch: '姓名搜索',
    businessCenterEmployeeUsernameSearch: '员工账号搜索',
    businessCenterEmployeeDepartmentFilter: '所属组织筛选',
    businessCenterEmployeeStatusFilter: '员工状态筛选',
    businessCenterEmployeeNamePlaceholder: '请输入员工姓名',
    businessCenterEmployeeUsernamePlaceholder: '请输入员工账号',
    businessCenterEmployeeAllDepartments: '全部组织',
    businessCenterEmployeeAllStatuses: '全部状态',
    businessCenterEmployeeSearch: '查询',
    businessCenterEmployeeReset: '重置',
    businessCenterEmployeeRefresh: '刷新员工数据',
    businessCenterEmployeeCreate: '新增员工',
    businessCenterEmployeeName: '员工姓名',
    businessCenterEmployeeUsername: '员工账号',
    businessCenterEmployeePhone: '手机号',
    businessCenterEmployeeEmail: '邮箱',
    businessCenterEmployeeDepartment: '所属组织',
    businessCenterEmployeeApplicationCount: '可用应用数',
    businessCenterEmployeeStatus: '员工状态',
    businessCenterEmployeeCreatedAt: '创建时间',
    businessCenterEmployeeLastLoginAt: '最近登录时间',
    businessCenterEmployeeActions: '操作',
    businessCenterEmployeeStatusActive: '启用',
    businessCenterEmployeeStatusDisabled: '停用',
    businessCenterEmployeeView: '查看',
    businessCenterEmployeeEdit: '编辑',
    businessCenterEmployeeConfigureApps: '配置应用',
    businessCenterEmployeeResetPassword: '重置密码',
    businessCenterEmployeeDisable: '停用',
    businessCenterEmployeeEnable: '启用',
    businessCenterEmployeeEmpty: '暂无匹配员工',
    businessCenterEmployeeLoading: '正在加载员工数据',
    businessCenterEmployeeTotalPrefix: '共',
    businessCenterEmployeeTotalSuffix: '条',
    businessCenterEmployeePageSize: '每页显示数量',
    businessCenterEmployeePerPage: '条/页',
    businessCenterEmployeePreviousPage: '上一页',
    businessCenterEmployeeNextPage: '下一页',
    businessCenterEmployeeViewTitle: '员工详情',
    businessCenterEmployeeEditTitle: '编辑员工',
    businessCenterEmployeeApplicationsTitle: '配置员工应用',
    businessCenterEmployeeClose: '关闭',
    businessCenterEmployeeDetailLoading: '正在加载员工详情',
    businessCenterEmployeeInitialPassword: '初始密码',
    businessCenterEmployeeRole: '员工角色',
    businessCenterEmployeeRoleEmployee: '普通员工',
    businessCenterEmployeeRoleAdmin: '管理员',
    businessCenterEmployeeNameInput: '请输入员工姓名',
    businessCenterEmployeeUsernameInput: '请输入员工账号（用于登录）',
    businessCenterEmployeePasswordInput: '请输入初始密码',
    businessCenterEmployeePasswordHelp: '至少 6 位字符',
    businessCenterEmployeePhoneInput: '请输入手机号',
    businessCenterEmployeeEmailInput: '请输入邮箱地址',
    businessCenterEmployeeDepartmentInput: '请选择所属组织',
    businessCenterEmployeeForcePasswordChange: '首次登录强制修改密码',
    businessCenterEmployeeAvailableApplications: '可用应用',
    businessCenterEmployeeApplicationHint: '只可分配当前企业已开通且仍在有效期内的应用。',
    businessCenterEmployeeNoApplications: '当前企业暂无可分配应用',
    businessCenterEmployeeCancel: '取消',
    businessCenterEmployeeSaveAndContinue: '保存并继续新增',
    businessCenterEmployeeSave: '保存',
    businessCenterEmployeeSaving: '保存中',
    businessCenterEmployeeResetPasswordTitle: '重置员工密码',
    businessCenterEmployeeResetPasswordHint: '重置后员工原密码立即失效。',
    businessCenterEmployeeNewPassword: '新密码',
    businessCenterEmployeeConfirmPassword: '确认新密码',
    businessCenterEmployeeConfirmReset: '确认重置',
    businessCenterEmployeeResetting: '重置中',
    businessCenterEmployeeDisableTitle: '停用员工',
    businessCenterEmployeeEnableTitle: '启用员工',
    businessCenterEmployeeDisableMessage: '确定要停用员工',
    businessCenterEmployeeEnableMessage: '确定要启用员工',
    businessCenterEmployeeProcessing: '处理中',
    businessCenterEmployeeLoadFailed: '加载员工失败',
    businessCenterEmployeeApplicationsLoadFailed: '加载企业应用失败',
    businessCenterEmployeeDetailLoadFailed: '加载员工详情失败',
    businessCenterEmployeeSaveFailed: '保存员工失败',
    businessCenterEmployeeStatusFailed: '更新员工状态失败',
    businessCenterEmployeePasswordResetFailed: '重置员工密码失败',
    businessCenterEmployeeNameRequired: '请输入员工姓名',
    businessCenterEmployeeUsernameRequired: '请输入员工账号',
    businessCenterEmployeePhoneRequired: '请输入员工手机号',
    businessCenterEmployeeDepartmentRequired: '请选择员工所属组织',
    businessCenterEmployeePasswordMin: '密码至少需要 6 位',
    businessCenterEmployeePasswordMismatch: '两次输入的密码不一致',
    ...
    pluginsCogneeCredentialSecureHint: '密码和 API Key 使用操作系统安全凭据存储加密；留空会保留已保存的凭据。',
    pluginsCogneeCredentialStored: '已安全保存：',
    pluginsCogneeTestConnection: '测试 Cognee 连接',
    pluginsCogneeTesting: '正在测试连接...',
    pluginsCogneeTestFailed: 'Cognee 连接测试失败',
    ...
    diagnosticsOtelTab: '诊断',
    diagnosticsOtelEnabled: 'OpenTelemetry 诊断',
    diagnosticsOtelEnabledDescription: '将 OpenClaw 运行诊断发送到配置的 OTLP HTTP 端点。',
    diagnosticsOtelEndpointTitle: '导出端点',
    diagnosticsOtelServiceName: '服务名称',
    diagnosticsOtelServiceNamePlaceholder: 'lzclaw-openclaw-gateway',
    diagnosticsOtelEndpointBaseUrl: '端点基础地址',
    diagnosticsOtelEndpointBaseUrlPlaceholder: 'https://lobsterai-server.youdao.com',
    diagnosticsOtelEndpointBaseUrlHint: '留空时使用当前 LobsterAI 服务地址，并自动拼接 /api/v1/traces、/metrics、/logs。',
    diagnosticsOtelTracesEndpoint: 'Traces 端点',
    diagnosticsOtelTracesEndpointPlaceholder: '自动生成',
    diagnosticsOtelMetricsEndpoint: 'Metrics 端点',
    diagnosticsOtelMetricsEndpointPlaceholder: '自动生成',
    diagnosticsOtelLogsEndpoint: 'Logs 端点',
    diagnosticsOtelLogsEndpointPlaceholder: '自动生成',
    diagnosticsOtelSignalsTitle: '信号',
    diagnosticsOtelTraces: 'Traces',
    diagnosticsOtelTracesDescription: '请求链路和关键阶段耗时。',
    diagnosticsOtelMetrics: 'Metrics',
    diagnosticsOtelMetricsDescription: '运行计数和延迟指标。',
    diagnosticsOtelLogs: 'Logs',
    diagnosticsOtelLogsDescription: '运行日志事件。',
    diagnosticsOtelSampleRate: '采样率',
    diagnosticsOtelSampleRateHint: '范围 0 到 1。',
    diagnosticsOtelFlushIntervalMs: '刷新间隔（毫秒）',
    diagnosticsOtelFlushIntervalMsHint: '范围 1000 到 600000。',
    diagnosticsOtelCaptureContent: '采集内容字段',
    diagnosticsOtelCaptureContentDescription: '默认关闭；开启后可能包含用户输入、模型输出或工具参数。',
    diagnosticsOtelCaptureInputMessages: '输入消息',
    diagnosticsOtelCaptureInputMessagesDescription: '采集用户输入文本。',
    diagnosticsOtelCaptureOutputMessages: '输出消息',
    diagnosticsOtelCaptureOutputMessagesDescription: '采集模型输出文本。',
    diagnosticsOtelCaptureToolInputs: '工具入参',
    diagnosticsOtelCaptureToolInputsDescription: '采集工具调用参数。',
    diagnosticsOtelCaptureToolOutputs: '工具输出',
    diagnosticsOtelCaptureToolOutputsDescription: '采集工具返回内容。',
    diagnosticsOtelCaptureSystemPrompt: '系统提示词',
    diagnosticsOtelCaptureSystemPromptDescription: '采集运行时系统提示词。',
    diagnosticsOtelCaptureToolDefinitions: '工具定义',
    diagnosticsOtelCaptureToolDefinitionsDescription: '采集工具名称与定义。',
    ...
    welcomeTitle: '欢迎使用 LZClaw',
    welcomeSubtitle: '把模型、项目和自动化任务放到一个桌面工作台里',
    welcomePromo: '新用户限时送百万Token',
    welcomeLogin: '登录',
    welcomeCustomModel: '自定义模型',
    onboardingClose: '关闭引导',
    onboardingEyebrow: '企业工作站',
    onboardingBack: '上一步',
    onboardingNext: '下一步',
    onboardingStart: '开始使用',
    onboardingGoToLogin: '去登录',
    onboardingStepIndicator: '第 {current} 步',
    onboardingStepLabel: '第 {current} / {total} 步',
    onboardingHintTitle: '稍后也可以修改',
    onboardingHintBody: '完成引导后进入登录页，再进入当前企业工作区。',
    onboardingStepWelcomeTitle: '企业 AI 工作站入口',
    onboardingStepWelcomeSubtitle: '账号、工作区和本地 AI 能力统一在桌面端。',
    onboardingStepWelcomeDetail1: '登录后自动进入默认企业工作区。',
    onboardingStepWelcomeDetail2: '企业额度和可用模型随账号同步。',
    onboardingStepWelcomeDetail3: '本地项目和 OpenClaw 能力保留在桌面端。',
    onboardingStepModelTitle: '先连接可用模型',
    onboardingStepModelSubtitle: 'LZClaw 会使用模型设置里的当前模型和提供商配置来驱动 Agent。',
    onboardingStepModelDetail1: '可以使用内置提供商，也可以添加兼容 OpenAI 或 Anthropic 格式的自定义模型。',
    onboardingStepModelDetail2: 'API Key、Base URL、模型列表和多模态能力都集中在模型设置里管理。',
    onboardingStepModelDetail3: '如果暂时还没有模型，也可以先进入应用，之后再从设置补齐。',
    onboardingStepWorkspaceTitle: '进入真实项目工作',
    onboardingStepWorkspaceSubtitle: '让 Agent 围绕本地文件、命令和上下文协作。',
    onboardingStepWorkspaceDetail1: '代码、文档和浏览器预览都可以在工作台处理。',
    onboardingStepWorkspaceDetail2: '敏感操作保留确认流程。',
    onboardingStepWorkspaceDetail3: '插件和 Skills 后续按需启用。',
    onboardingStepReadyTitle: '准备好了',
    onboardingStepReadySubtitle: '现在可以进入 LZClaw，开始一个新任务，或先完成登录和模型配置。',
    onboardingStepReadyDetail1: '直接开始：进入工作台后从输入框描述你要完成的任务。',
    onboardingStepReadyDetail2: '登录账号：同步账号能力和在线服务入口。',
    onboardingStepReadyDetail3: '自定义模型：马上打开模型设置，先把 API Key 和默认模型配好。',
    onboardingStepStartTitle: '准备进入工作台',
    onboardingStepStartSubtitle: '模型、额度、插件和工作区状态会随账号同步。',
    onboardingStepStartDetail1: '登录后即可进入当前企业工作区。',
    onboardingStepStartDetail2: '多企业成员可在应用内切换工作区。',
    onboardingStepStartDetail3: '模型和外观设置后续继续调整。',
    onboardingStartCardTitle: '准备进入',
    onboardingStartCardSubtitle: '点击开始使用，完成引导并进入下一步。',
    onboardingStepLoginTitle: '使用企业账号登录',
    onboardingStepLoginSubtitle: '登录后自动进入默认工作区，无需提前选择企业。',
    onboardingStepLoginDetail1: '账号验证通过后换取 LZClaw 工作站会话。',
    onboardingStepLoginDetail2: '登录页只保留真实企业账号入口。',
    onboardingStepLoginDetail3: '多企业账号可登录后切换工作区。',
    onboardingLoginCardTitle: '登录账号',
    onboardingLoginCardSubtitle: '使用企业账号密码登录后进入当前工作区。',
    onboardingLoginPrimary: '使用企业账号登录',
    onboardingLoginCustomModel: '先配置自定义模型',
    onboardingLoginSkip: '稍后登录',
  ...
  en: {
    ...
    personalCenterSubtitle: 'View your account, plan, and credit balance.',
    personalCenterAccountInfo: 'Account Info',
    personalCenterQuotaOverview: 'Quota Overview',
    personalCenterWorkspace: 'Workspace',
    personalCenterCurrentWorkspace: 'Current Workspace',
    personalCenterWorkspaceRole: 'Workspace Role',
    personalCenterSwitchWorkspace: 'Switch Workspace',
    personalCenterSwitchingWorkspace: 'Switching workspace',
    personalCenterSwitchWorkspaceFailed: 'Failed to switch workspace',
    personalCenterUserId: 'User ID',
    personalCenterAccountStatus: 'Account Status',
    personalCenterPlan: 'Current Plan',
    personalCenterSubscriptionStatus: 'Subscription Status',
    personalCenterCreditsLimit: 'Total Credits',
    personalCenterCreditsUsed: 'Used',
    personalCenterCreditsRemaining: 'Remaining',
    personalCenterCreditBreakdown: 'Credit Breakdown',
    personalCenterNoCreditItems: 'No credit details yet',
    personalCenterNoExpiry: 'No expiry',
    personalCenterRefresh: 'Refresh',
    personalCenterRefreshing: 'Refreshing',
    personalCenterRefreshFailed: 'Failed to refresh profile',
    personalCenterLogoutFailed: 'Failed to log out',
    personalCenterLoggingOut: 'Logging out',
    login: 'Login',
    ...
    appStartingTitle: 'Starting LZClaw',
    appStartingSubtitle: 'Initializing...',
    appStartingSlowHint: 'First launch is loading settings and local services. Please wait.',
    ...
    businessCenterComingSoon: 'This module is coming soon',
    businessCenterOrgTitle: 'Organization Management',
    businessCenterOrgDescription:
      'Manage the enterprise organization tree. Add, edit, enable, disable, and delete nodes with changes taking effect immediately.',
    businessCenterOrgSearchPlaceholder: 'Search organization name/code',
    businessCenterOrgAllStatus: 'All statuses',
    businessCenterOrgActive: 'Active',
    businessCenterOrgDisabled: 'Disabled',
    businessCenterOrgAdd: 'Add organization node',
    businessCenterOrgCode: 'Organization code',
    businessCenterOrgStructure: 'Organization',
    businessCenterOrgManager: 'Manager',
    businessCenterOrgStatus: 'Status',
    businessCenterOrgCreatedAt: 'Created at',
    businessCenterOrgActions: 'Actions',
    businessCenterOrgEdit: 'Edit',
    businessCenterOrgEnable: 'Enable',
    businessCenterOrgDisable: 'Disable',
    businessCenterOrgDelete: 'Delete',
    businessCenterOrgMore: 'More actions',
    businessCenterOrgEmpty: 'No matching organization nodes',
    businessCenterOrgLoading: 'Loading organization',
    businessCenterOrgCreateTitle: 'Add organization node',
    businessCenterOrgEditTitle: 'Edit organization node',
    businessCenterOrgName: 'Organization name',
    businessCenterOrgParent: 'Parent organization',
    businessCenterOrgNoParent: 'No parent organization',
    businessCenterOrgSort: 'Sort',
    businessCenterOrgNamePlaceholder: 'Enter organization node name',
    businessCenterOrgCodePlaceholder: 'Enter organization node code',
    businessCenterOrgManagerPlaceholder: 'Select manager',
    businessCenterOrgSortPlaceholder: 'Enter sort order; smaller numbers appear first',
    businessCenterOrgClose: 'Close modal',
    businessCenterOrgCancel: 'Cancel',
    businessCenterOrgSave: 'Save',
    businessCenterOrgSaving: 'Saving',
    businessCenterOrgNameRequired: 'Enter organization node name',
    ...
    businessCenterEmployeeTitle: 'Employee Management',
    businessCenterEmployeeDescription: 'Manage employee accounts, organizations, status, and application access.',
    businessCenterEmployeeTotal: 'Total employees',
    businessCenterEmployeeActive: 'Active',
    businessCenterEmployeeDisabled: 'Disabled',
    businessCenterEmployeeAddedThisMonth: 'Added this month',
    businessCenterEmployeeAllMembers: 'All enterprise members',
    businessCenterEmployeeCurrentMonth: 'Members created this month',
    businessCenterEmployeeNameSearch: 'Name',
    businessCenterEmployeeUsernameSearch: 'Account',
    businessCenterEmployeeDepartmentFilter: 'Organization',
    businessCenterEmployeeStatusFilter: 'Status',
    businessCenterEmployeeNamePlaceholder: 'Enter employee name',
    businessCenterEmployeeUsernamePlaceholder: 'Enter employee account',
    businessCenterEmployeeAllDepartments: 'All organizations',
    businessCenterEmployeeAllStatuses: 'All statuses',
    businessCenterEmployeeSearch: 'Search',
    businessCenterEmployeeReset: 'Reset',
    businessCenterEmployeeRefresh: 'Refresh employee data',
    businessCenterEmployeeCreate: 'Add employee',
    businessCenterEmployeeName: 'Employee name',
    businessCenterEmployeeUsername: 'Employee account',
    businessCenterEmployeePhone: 'Phone',
    businessCenterEmployeeEmail: 'Email',
    businessCenterEmployeeDepartment: 'Organization',
    businessCenterEmployeeApplicationCount: 'Applications',
    businessCenterEmployeeStatus: 'Status',
    businessCenterEmployeeCreatedAt: 'Created at',
    businessCenterEmployeeLastLoginAt: 'Last login',
    businessCenterEmployeeActions: 'Actions',
    businessCenterEmployeeStatusActive: 'Active',
    businessCenterEmployeeStatusDisabled: 'Disabled',
    businessCenterEmployeeView: 'View',
    businessCenterEmployeeEdit: 'Edit',
    businessCenterEmployeeConfigureApps: 'Applications',
    businessCenterEmployeeResetPassword: 'Reset password',
    businessCenterEmployeeDisable: 'Disable',
    businessCenterEmployeeEnable: 'Enable',
    businessCenterEmployeeEmpty: 'No matching employees',
    businessCenterEmployeeLoading: 'Loading employees',
    businessCenterEmployeeTotalPrefix: 'Total',
    businessCenterEmployeeTotalSuffix: 'items',
    businessCenterEmployeePageSize: 'Page size',
    businessCenterEmployeePerPage: 'per page',
    businessCenterEmployeePreviousPage: 'Previous page',
    businessCenterEmployeeNextPage: 'Next page',
    businessCenterEmployeeViewTitle: 'Employee details',
    businessCenterEmployeeEditTitle: 'Edit employee',
    businessCenterEmployeeApplicationsTitle: 'Configure applications',
    businessCenterEmployeeClose: 'Close',
    businessCenterEmployeeDetailLoading: 'Loading employee details',
    businessCenterEmployeeInitialPassword: 'Initial password',
    businessCenterEmployeeRole: 'Role',
    businessCenterEmployeeRoleEmployee: 'Employee',
    businessCenterEmployeeRoleAdmin: 'Administrator',
    businessCenterEmployeeNameInput: 'Enter employee name',
    businessCenterEmployeeUsernameInput: 'Enter account used to sign in',
    businessCenterEmployeePasswordInput: 'Enter initial password',
    businessCenterEmployeePasswordHelp: 'At least 6 characters',
    businessCenterEmployeePhoneInput: 'Enter phone number',
    businessCenterEmployeeEmailInput: 'Enter email address',
    businessCenterEmployeeDepartmentInput: 'Select organization',
    businessCenterEmployeeForcePasswordChange: 'Require password change at first sign-in',
    businessCenterEmployeeAvailableApplications: 'Available applications',
    businessCenterEmployeeApplicationHint: 'Only active applications authorized for this enterprise can be assigned.',
    businessCenterEmployeeNoApplications: 'No applications are available for this enterprise',
    businessCenterEmployeeCancel: 'Cancel',
    businessCenterEmployeeSaveAndContinue: 'Save and add another',
    businessCenterEmployeeSave: 'Save',
    businessCenterEmployeeSaving: 'Saving',
    businessCenterEmployeeResetPasswordTitle: 'Reset employee password',
    businessCenterEmployeeResetPasswordHint: 'The previous password becomes invalid immediately.',
    businessCenterEmployeeNewPassword: 'New password',
    businessCenterEmployeeConfirmPassword: 'Confirm password',
    businessCenterEmployeeConfirmReset: 'Reset password',
    businessCenterEmployeeResetting: 'Resetting',
    businessCenterEmployeeDisableTitle: 'Disable employee',
    businessCenterEmployeeEnableTitle: 'Enable employee',
    businessCenterEmployeeDisableMessage: 'Disable employee',
    businessCenterEmployeeEnableMessage: 'Enable employee',
    businessCenterEmployeeProcessing: 'Processing',
    businessCenterEmployeeLoadFailed: 'Failed to load employees',
    businessCenterEmployeeApplicationsLoadFailed: 'Failed to load enterprise applications',
    businessCenterEmployeeDetailLoadFailed: 'Failed to load employee details',
    businessCenterEmployeeSaveFailed: 'Failed to save employee',
    businessCenterEmployeeStatusFailed: 'Failed to update employee status',
    businessCenterEmployeePasswordResetFailed: 'Failed to reset employee password',
    businessCenterEmployeeNameRequired: 'Enter employee name',
    businessCenterEmployeeUsernameRequired: 'Enter employee account',
    businessCenterEmployeePhoneRequired: 'Enter employee phone number',
    businessCenterEmployeeDepartmentRequired: 'Select the employee organization',
    businessCenterEmployeePasswordMin: 'Password must be at least 6 characters',
    businessCenterEmployeePasswordMismatch: 'The passwords do not match',
    mcpDescription:
    ...
    pluginsCogneeCredentialSecureHint: 'Passwords and API keys are encrypted by the operating system. Leave them blank to keep saved credentials.',
    pluginsCogneeCredentialStored: 'Securely stored:',
    pluginsCogneeTestConnection: 'Test Cognee connection',
    pluginsCogneeTesting: 'Testing connection...',
    pluginsCogneeTestFailed: 'Cognee connection test failed',
    pluginsSourceOpenclaw: 'OpenClaw',
    ...
    diagnosticsOtelTab: 'Diagnostics',
    diagnosticsOtelEnabled: 'OpenTelemetry diagnostics',
    diagnosticsOtelEnabledDescription:
      'Send OpenClaw runtime diagnostics to the configured OTLP HTTP endpoint.',
    diagnosticsOtelEndpointTitle: 'Exporter endpoint',
    diagnosticsOtelServiceName: 'Service name',
    diagnosticsOtelServiceNamePlaceholder: 'lzclaw-openclaw-gateway',
    diagnosticsOtelEndpointBaseUrl: 'Endpoint base URL',
    diagnosticsOtelEndpointBaseUrlPlaceholder: 'https://lobsterai-server.youdao.com',
    diagnosticsOtelEndpointBaseUrlHint:
      'When empty, the current LobsterAI service URL is used and /api/v1/traces, /metrics, and /logs are appended.',
    diagnosticsOtelTracesEndpoint: 'Traces endpoint',
    diagnosticsOtelTracesEndpointPlaceholder: 'Auto-generated',
    diagnosticsOtelMetricsEndpoint: 'Metrics endpoint',
    diagnosticsOtelMetricsEndpointPlaceholder: 'Auto-generated',
    diagnosticsOtelLogsEndpoint: 'Logs endpoint',
    diagnosticsOtelLogsEndpointPlaceholder: 'Auto-generated',
    diagnosticsOtelSignalsTitle: 'Signals',
    diagnosticsOtelTraces: 'Traces',
    diagnosticsOtelTracesDescription: 'Request flow and stage timing.',
    diagnosticsOtelMetrics: 'Metrics',
    diagnosticsOtelMetricsDescription: 'Runtime counters and latency metrics.',
    diagnosticsOtelLogs: 'Logs',
    diagnosticsOtelLogsDescription: 'Runtime log events.',
    diagnosticsOtelSampleRate: 'Sample rate',
    diagnosticsOtelSampleRateHint: 'Range: 0 to 1.',
    diagnosticsOtelFlushIntervalMs: 'Flush interval (ms)',
    diagnosticsOtelFlushIntervalMsHint: 'Range: 1000 to 600000.',
    diagnosticsOtelCaptureContent: 'Capture content fields',
    diagnosticsOtelCaptureContentDescription:
      'Off by default. When enabled, payloads may include user input, model output, or tool arguments.',
    diagnosticsOtelCaptureInputMessages: 'Input messages',
    diagnosticsOtelCaptureInputMessagesDescription: 'Capture user input text.',
    diagnosticsOtelCaptureOutputMessages: 'Output messages',
    diagnosticsOtelCaptureOutputMessagesDescription: 'Capture model output text.',
    diagnosticsOtelCaptureToolInputs: 'Tool inputs',
    diagnosticsOtelCaptureToolInputsDescription: 'Capture tool call arguments.',
    diagnosticsOtelCaptureToolOutputs: 'Tool outputs',
    diagnosticsOtelCaptureToolOutputsDescription: 'Capture tool return content.',
    diagnosticsOtelCaptureSystemPrompt: 'System prompt',
    diagnosticsOtelCaptureSystemPromptDescription: 'Capture the runtime system prompt.',
    diagnosticsOtelCaptureToolDefinitions: 'Tool definitions',
    diagnosticsOtelCaptureToolDefinitionsDescription: 'Capture tool names and definitions.',
    ...
    welcomeTitle: 'Welcome to LZClaw',
    welcomeSubtitle: 'Bring models, projects, and automation into one desktop workspace',
    welcomePromo: 'New users get 1M free tokens',
    welcomeLogin: 'Login',
    welcomeCustomModel: 'Custom Model',
    onboardingClose: 'Close onboarding',
    onboardingEyebrow: 'Enterprise workstation',
    onboardingBack: 'Back',
    onboardingNext: 'Next',
    onboardingStart: 'Start using',
    onboardingGoToLogin: 'Go to sign in',
    onboardingStepIndicator: 'Step {current}',
    onboardingStepLabel: 'Step {current} / {total}',
    onboardingHintTitle: 'You can change this later',
    onboardingHintBody: 'After onboarding, sign in and enter your current enterprise workspace.',
    onboardingStepWelcomeTitle: 'Enterprise AI workstation',
    onboardingStepWelcomeSubtitle: 'One desktop entry for accounts, workspaces, and local AI.',
    onboardingStepWelcomeDetail1: 'Sign in once to enter the default enterprise workspace.',
    onboardingStepWelcomeDetail2: 'Balance and available models sync with your account.',
    onboardingStepWelcomeDetail3: 'Local projects and OpenClaw stay on the desktop.',
    onboardingStepModelTitle: 'Connect a model first',
    onboardingStepModelSubtitle: 'LZClaw uses the current model and provider configuration from Model Settings.',
    onboardingStepModelDetail1: 'Use built-in providers or add custom models compatible with OpenAI or Anthropic APIs.',
    onboardingStepModelDetail2: 'API keys, base URLs, model lists, and multimodal capability flags are managed in one place.',
    onboardingStepModelDetail3: 'You can also enter the app now and finish model setup later from Settings.',
    onboardingStepWorkspaceTitle: 'Work inside real projects',
    onboardingStepWorkspaceSubtitle: 'Let agents work with local files, commands, and context.',
    onboardingStepWorkspaceDetail1: 'Code, docs, and browser previews live in one workspace.',
    onboardingStepWorkspaceDetail2: 'Sensitive actions still require confirmation.',
    onboardingStepWorkspaceDetail3: 'Plugins and Skills can be enabled later.',
    onboardingStepReadyTitle: 'You are ready',
    onboardingStepReadySubtitle: 'Enter LZClaw now, start a new task, or finish login and model setup first.',
    onboardingStepReadyDetail1: 'Start directly: describe the task in the prompt box after entering the workspace.',
    onboardingStepReadyDetail2: 'Login: connect account capabilities and online service entry points.',
    onboardingStepReadyDetail3: 'Custom model: open Model Settings now and configure your API key and default model.',
    onboardingStepStartTitle: 'Ready for the workspace',
    onboardingStepStartSubtitle: 'Models, quota, plugins, and workspace state sync with your account.',
    onboardingStepStartDetail1: 'Sign in to enter the current enterprise workspace.',
    onboardingStepStartDetail2: 'Switch workspaces after sign-in when needed.',
    onboardingStepStartDetail3: 'Models and appearance can be adjusted later.',
    onboardingStartCardTitle: 'Ready to enter',
    onboardingStartCardSubtitle: 'Select Start using to finish onboarding and continue.',
    onboardingStepLoginTitle: 'Sign in with enterprise account',
    onboardingStepLoginSubtitle:
      'Sign in and enter the default workspace without choosing an enterprise first.',
    onboardingStepLoginDetail1: 'Verification creates a LZClaw workstation session.',
    onboardingStepLoginDetail2: 'The sign-in page keeps only real enterprise account login.',
    onboardingStepLoginDetail3: 'Switch workspace after sign-in when needed.',
    onboardingLoginCardTitle: 'Sign in',
    onboardingLoginCardSubtitle: 'Use your enterprise account and password to enter the current workspace.',
    onboardingLoginPrimary: 'Sign in with enterprise account',
    onboardingLoginCustomModel: 'Configure custom model first',
    onboardingLoginSkip: 'Sign in later',
