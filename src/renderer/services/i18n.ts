...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道LZClaw服务协议',
    privacyDialogDesc: '在使用网易有道LZClaw之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道LZClaw服务协议',
  ...
  en: {
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao LZClaw Terms of Service',
    privacyDialogDesc:
      'Before using NetEase Youdao LZClaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao LZClaw Terms of Service',
