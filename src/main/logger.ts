 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/LZClaw/main-YYYY-MM-DD.log
 *   Windows: %USERPROFILE%\AppData\Roaming\LZClaw\logs\main-YYYY-MM-DD.log
 *   Linux:   ~/.config/LZClaw/logs/main-YYYY-MM-DD.log
 *
 * Rotation policy:
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`LZClaw started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
