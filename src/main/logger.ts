 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/htmmai/main-YYYY-MM-DD.log
 *   Windows: %USERPROFILE%\AppData\Roaming\htmmai\logs\main-YYYY-MM-DD.log
 *   Linux:   ~/.config/htmmai/logs/main-YYYY-MM-DD.log
 *
 * Rotation policy:
