...
!macro customCheckAppRunning
  !insertmacro stopLZClawProcesses

  !ifndef BUILD_UNINSTALLER
    ; -- Clean stale openclaw-weixin session data --
    ; On reinstall, old bot tokens can cause the ilink server to reject new QR
    ; logins because it still considers the old session active.
