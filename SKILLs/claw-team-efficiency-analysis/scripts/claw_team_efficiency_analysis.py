...
CONFIG = {
  "agent_name": "老板驾驶舱·秦略 Agent",
  "skill_name": "LZClaw-团队效率分析",
  "skill_dir": "claw-team-efficiency-analysis",
  "default_mode": "team-efficiency",
  "sources": [
    "users",
    "assignable_users",
    "customers",
  ...
  "interface_usage": [
    {
      "endpoint": "GET /users",
      "purpose": "读取用户列表，用于团队分析、主管辅导、销售归因和组织视角复盘。",
      "timing": "当技能需要按销售人员或团队成员聚合数据时调用。",
      "params": "用户筛选条件来自用户请求；缺省使用默认分页。",
    ...
    {
      "endpoint": "GET /my-customers",
      "purpose": "读取当前账号负责的客户列表，用于阶段、风险、预测、团队和经营分析。",
      "timing": "当技能需要批量查看客户、统计客户阶段或选择重点客户时调用。",
      "params": "分页、阶段、关键词、负责人等筛选条件来自用户请求；缺省使用默认分页。",
      "safety": "只读接口，可直接用于分析，不修改 CRM 数据。"
    },
    {
  ...
  "primary": "users",
  "judgment": "团队效率分析要区分能力问题和资源问题。",
  "next_action": "团队效率问题交给销售主管复盘或培训教练。",
  "handoff": "销售主管·周督 Agent",
  "checks": [
    "销售客户量",
    "阶段推进",
    "AI 使用",
