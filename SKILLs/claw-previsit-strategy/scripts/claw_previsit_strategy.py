...
CONFIG = {
  ...
  "skill_name": "LZClaw-访前策略",
  "skill_dir": "claw-previsit-strategy",
  "default_mode": "previsit",
  "sources": [
    "customer_detail"
  ],
  "dict_types": [],
  ...
  "interface_usage": [
    ...
    {
      "endpoint": "POST /customers/{customer_id}/previsit-summary-drafts",
      "purpose": "生成客户访前建议草稿。",
      "timing": "当用户需要拜访前准备、一面目标或沟通问题时调用。",
      "params": "`customer_id` 来自客户；补充目标来自用户输入。",
  ...
  "primary": "customers",
  "judgment": "访前策略要能指导 20-30 分钟有效沟通。",
  "next_action": "访前准备完成后进入一面沟通流程。",
  "handoff": "LZClaw-一面沟通流程",
  "checks": [
    "客户经营现状",
    "一面目标",
    "重点问题",
