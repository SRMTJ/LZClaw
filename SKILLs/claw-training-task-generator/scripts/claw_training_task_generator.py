...
CONFIG = {
  "agent_name": "培训复盘教练·陶练 Agent",
  "skill_name": "LZClaw-训练任务生成",
  "skill_dir": "claw-training-task-generator",
  "default_mode": "training-task",
  "sources": [
    "customers",
    "ai_records",
    "users"
  ...
  "primary": "customers",
  "judgment": "训练任务要可练习、可检核、可复盘。",
  "next_action": "训练任务交给主管检核和辅导跟进。",
  "handoff": "LZClaw-主管辅导建议",
  "checks": [
    "能力短板",
    "训练主题",
    "模拟场景",
