...
CONFIG = {
  "agent_name": "客情诊断师·闻策 Agent",
  "skill_name": "LZClaw-客户阶段校验",
  "skill_dir": "claw-customer-stage-check",
  ...
  "primary": "ai_records",
  "judgment": "阶段校验需结合 AI 结果与人工确认。",
  "next_action": "校验通过后由用户确认阶段推进。",
