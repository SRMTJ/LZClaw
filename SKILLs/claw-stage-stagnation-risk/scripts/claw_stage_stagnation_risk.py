...
CONFIG = {
  ...
  "skill_name": "LZClaw-阶段停留与风险识别",
  "skill_dir": "claw-stage-stagnation-risk",
  "default_mode": "stagnation",
  "sources": [
    "customers",
    "customer_detail",
    "ai_records",
  ...
  "primary": "customers",
  "judgment": "风险识别要说明影响成交的具体原因。",
  "next_action": "风险客户进入销售动作质检或主管介入。",
  "handoff": "LZClaw-销售动作质检",
  "checks": [
    "阶段停留时长",
    "客户价值",
    "缺失动作",
