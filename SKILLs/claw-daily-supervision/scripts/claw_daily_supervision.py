...
CONFIG = {
  ...
  "skill_name": "LZClaw-今日督办",
  "skill_dir": "claw-daily-supervision",
  "default_mode": "daily-supervision",
  "sources": [
    "leads",
    "customers",
    "notifications",
  ...
  "interface_usage": [
    ...
    },
    {
      ...
      "purpose": "读取通知列表，用于主管督办、服务衔接和经营风险提醒。",
      "timing": "当技能需要查看待处理通知、阶段提醒或系统提醒时调用。",
      "params": "通知状态、类型、时间范围来自用户请求；缺省读取当前账号通知。",
      "safety": "只读接口，可直接用于分析，不修改 CRM 数据。"
    },
    {
  ...
  "primary": "customers",
  "judgment": "督办清单要按优先级排序。",
  "next_action": "今日重点客户进入阶段真实性或动作质检。",
  "handoff": "LZClaw-阶段真实性检查",
  "checks": [
    "高优先级客户",
    "今日动作",
    "通知",
