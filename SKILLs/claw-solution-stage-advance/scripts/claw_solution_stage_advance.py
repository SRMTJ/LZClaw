...
CONFIG = {
  "agent_name": "方案推进顾问·沈案 Agent",
  "skill_name": "LZClaw-方案阶段推进",
  "skill_dir": "claw-solution-stage-advance",
  ...
  "primary": "ai_records",
  "judgment": "推进阶段必须有沟通证据和客户反馈。",
  "next_action": "满足 B 阶段条件后交给成交转化。",
  "handoff": "成交转化官·顾成 Agent",
  "checks": [
    "是否完成有效方案沟通",
    "客户是否认可方向",
    "下一步是否明确",
