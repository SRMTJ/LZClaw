...
CONFIG = {
  ...
  "skill_name": "LZClaw-合同付款话术",
  "skill_dir": "claw-contract-payment-script",
  "default_mode": "contract-script",
  "sources": [
    "customer_detail",
    "notifications"
  ],
  ...
  "judgment": "付款话术要低压但明确下一步时间。",
  "next_action": "客户完成付款或确认服务启动后进入服务群衔接。",
  "handoff": "LZClaw-服务群衔接",
  "checks": [
    "话术场景",
    "付款节点",
    "客户顾虑",
