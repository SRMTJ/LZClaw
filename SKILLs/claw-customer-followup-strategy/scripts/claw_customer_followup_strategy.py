...
CONFIG = {
  ...
  "skill_name": "LZClaw-客户跟进策略",
  "skill_dir": "claw-customer-followup-strategy",
  "default_mode": "plan",
  "sources": [
    "customer_detail"
  ],
  ...
  "interfaces": [
    ...
    "POST /customers/{customer_id}/follow-up-summary-drafts",
  ...
  "interface_usage": [
    ...
    {
      "endpoint": "POST /customers/{customer_id}/follow-up-summary-drafts",
      "purpose": "生成客户跟进总结草稿。",
      "timing": "当用户需要整理客户沟通、拜访或电话纪要时调用。",
      "params": "`customer_id` 来自客户；沟通内容来自用户输入或 CRM 上下文。",
      "safety": "POST 写操作，会改变 CRM 状态或生成业务记录，必须在用户明确要求并确认对象后才调用；脚本默认 dry-run，需 `--execute` 才执行。"
    },
    {
  ...
  "primary": "customers",
  "judgment": "跟进策略必须落到具体动作和时间。",
  "next_action": "跟进完成后按证据进入阶段校验。",
  "handoff": "LZClaw-客户阶段校验",
  "checks": [
    "跟进目标",
    "沟通内容",
    "下一步动作",
