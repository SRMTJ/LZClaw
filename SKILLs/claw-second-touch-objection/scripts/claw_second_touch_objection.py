...
CONFIG = {
  ...
  "skill_name": "LZClaw-二次触达与异议应答",
  "skill_dir": "claw-second-touch-objection",
  "default_mode": "second-touch",
  "sources": [
    "lead_detail",
    "ai_records"
  ],
  ...
  "primary": "ai_records",
  "judgment": "早期异议先判断真实性，再给低压跟进动作。",
  "next_action": "二次触达产生有效互动后，进入线索跟进总结。",
  "handoff": "LZClaw-线索跟进总结",
  "checks": [
    "客户真实反馈",
    "早期异议类型",
    "二次触达时机",
