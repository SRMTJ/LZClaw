...
CONFIG = {
  "agent_name": "销售主管·周督 Agent",
  "skill_name": "LZClaw-团队过程复盘",
  "skill_dir": "claw-team-process-review",
  "default_mode": "team-review",
  "sources": [
    "users",
    "assignable_users",
    "customers",
  ...
  "primary": "users",
  "judgment": "团队复盘要识别可复制打法和需要辅导的人。",
  "next_action": "团队复盘结果交给老板驾驶舱做经营判断。",
  "handoff": "老板驾驶舱·秦略 Agent",
  "checks": [
    "团队阶段分布",
    "销售动作质量",
    "AI 使用记录",
