...
CONFIG = {
  ...
  "skill_name": "LZClaw-行业区域机会分析",
  "skill_dir": "claw-industry-region-opportunity",
  "default_mode": "industry-region",
  "sources": [
    "leads",
    "customers",
    "dictionaries",
  ...
  "primary": "customers",
  "judgment": "行业区域建议要基于转化和成交质量。",
  "next_action": "机会判断进入资源配置和下周拓客策略。",
  "handoff": "LZClaw-风险预警与资源配置",
  "checks": [
    "行业转化",
    "区域表现",
    "线索来源",
