...
CONFIG = {
  ...
  "skill_name": "LZClaw-阶段真实性检查",
  "skill_dir": "claw-stage-authenticity-audit",
  "default_mode": "stage-audit",
  "sources": [
    "customers",
    "customer_detail",
    "ai_records",
  ...
  "primary": "customers",
  "judgment": "阶段真实性必须以证据为准。",
  "next_action": "阶段虚高或停滞客户进入停留风险分析。",
  "handoff": "LZClaw-阶段停留与风险识别",
  "checks": [
    "当前阶段",
    "阶段证据",
    "AI 记录",
