...
CONFIG = {
  ...
  "skill_name": "LZClaw-异议与卡点诊断",
  "skill_dir": "claw-customer-objection-diagnosis",
  "default_mode": "objection",
  "sources": [
    "customer_detail",
    "ai_records"
  ],
  ...
  "primary": "ai_records",
  "judgment": "卡点诊断要说明证据来源和待验证问题。",
  "next_action": "给出补问动作后进入客户跟进策略。",
  "handoff": "LZClaw-客户跟进策略",
  "checks": [
    "异议类型",
    "卡点原因",
    "记录完整度",
