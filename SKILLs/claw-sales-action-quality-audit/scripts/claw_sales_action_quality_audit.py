...
CONFIG = {
  ...
  "skill_name": "LZClaw-销售动作质检",
  "skill_dir": "claw-sales-action-quality-audit",
  "default_mode": "action-audit",
  "sources": [
    "customers",
    "customer_detail",
    "ai_records",
  ...
  "primary": "customers",
  "judgment": "动作质检要按客户阶段列出缺失项。",
  "next_action": "动作缺失严重时输出主管介入方案。",
  "handoff": "LZClaw-主管介入与辅导",
  "checks": [
    "应做动作",
    "已做动作",
    "动作质量",
